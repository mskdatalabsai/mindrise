...
import { policyPageIntro } from "@/lib/data";
  ...
  return (
    <section className="relative overflow-hidden bg-midnight px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <Badge icon={ScrollText} tone="dark">
          Legal
        </Badge>
        ...
        <h1 className="mt-6 text-balance font-display text-3xl font-extrabold leading-tight tracking-tight text-fog-100 sm:text-4xl lg:text-5xl">
          {policyPageIntro.title}
        </h1>

        <p className="mt-3 text-sm font-medium text-brand-teal">
          {policyPageIntro.effectiveDate}
        </p>

        <div className="mx-auto mt-6 flex max-w-2xl flex-col gap-3 text-pretty text-base leading-relaxed text-fog-400">
          {policyPageIntro.paragraphs.map((paragraph) => (
